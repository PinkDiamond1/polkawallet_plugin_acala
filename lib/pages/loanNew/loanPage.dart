                                  ...
                                  children: [
                                    ...
                                    LoanItemView(
                                      progress: debits / maxToBorrow > 1
                                          ...
                                          : debits / maxToBorrow,
                                      progressText:
                                          "${Fmt.priceFloorFormatter(debits)} ${PluginFmt.tokenView(acala_stable_coin)} ${dic['v3.loan.minted']}",
                                      btnText:
                                      ...
                                      detailWidget: Column(
                                        ...
                                        children: [
                                          InfoItemRow(dic['v3.totalBalance']!,
                                              "${Fmt.priceFloorBigIntFormatter(balanceStableCoin, balancePair[1].decimals!)} ${PluginFmt.tokenView(acala_stable_coin)}",
                                              labelStyle: itemStype,
                                              contentStyle: itemStype),
                                          InfoItemRow(dic['v3.loan.canMint']!,
                                              '${Fmt.priceFloorBigInt(canMint, balancePair[1].decimals!)} ${PluginFmt.tokenView(acala_stable_coin)}',
                                              labelStyle: itemStype,
                                              contentStyle: itemStype),
                                          InfoItemRow(
                                              dic['v3.loan.canPayback']!,
                                              '${Fmt.priceFloorBigIntFormatter(canPayback, balancePair[1].decimals!)} ${PluginFmt.tokenView(acala_stable_coin)}',
                                              labelStyle: itemStype,
                                              contentStyle: itemStype)
                                        ],
                                      ),
