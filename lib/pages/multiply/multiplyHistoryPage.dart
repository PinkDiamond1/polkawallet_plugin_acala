...
import 'package:polkawallet_plugin_acala/api/types/txMultiplyData.dart';
...
class MultiplyHistoryPage extends StatelessWidget {
  ...
  static const String route = '/acala/multiply/txs';
            ...
            builder: (
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int i) {
                  ...
                  var describe =
                      "${detail.amountDebit} ${PluginFmt.tokenView(acala_stable_coin_view)} in debt and buy ${detail.amountCollateral} ${PluginFmt.tokenView(detail.token)}";
                  if (detail.action == TxMultiplyData.expand) {
                    describe =
                        "${detail.amountDebit} ${PluginFmt.tokenView(acala_stable_coin_view)} in debt and buy ${detail.amountCollateral} ${PluginFmt.tokenView(detail.token)}";
                  } else if (detail.action == TxMultiplyData.shrink) {
                    describe =
                        "${detail.amountDebit} ${PluginFmt.tokenView(acala_stable_coin_view)} in debt and sell ${detail.amountCollateral} ${PluginFmt.tokenView(detail.token)}";
                  }
                  return Container(
