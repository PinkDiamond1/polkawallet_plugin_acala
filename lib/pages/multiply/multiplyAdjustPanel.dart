...
class _MultiplyAdjustPanelState extends State<MultiplyAdjustPanel> {
    ...
    return {
      'detail': {
        ...
        dic['loan.multiply.outstandingDebt']: Text(
          '${Fmt.priceCeilBigInt(debitNew - raisingDebit, balancePair[1].decimals!, lengthMax: 8)} $acala_stable_coin_view',
          style: Theme.of(context)
              .textTheme
              .headline1
              ?.copyWith(color: PluginColorsDark.headline1),
  ...
  Map _getSellingParams(LoanType loanType, List<TokenBalanceData> balancePair,
    ...
    final detail = {
      ...
      dic['loan.multiply.outstandingDebt']: Text(
        '≈ ${Fmt.priceCeilBigInt(debitNew, balancePair[1].decimals!, lengthMax: 8)} $acala_stable_coin_view',
        style: Theme.of(context)
            .textTheme
            .headline1
            ?.copyWith(color: PluginColorsDark.headline1),
