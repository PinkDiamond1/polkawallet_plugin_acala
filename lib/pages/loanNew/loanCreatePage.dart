            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                Padding(
                    ...
                    child: InfoItemRow(
                      dic['v3.maxCanMint']!,
                      "$maxToBorrow $acala_stable_coin_view",
                ...
                Padding(
                    ...
                    child: InfoItemRow(
                      ...
                      "${Fmt.priceCeilBigInt(loanType.minimumDebitValue, balancePair[1].decimals!)} $acala_stable_coin_view",
                      labelStyle: Theme.of(context)
                          .textTheme
                          .headline4
                          ?.copyWith(
                ...
                Padding(
                    ...
                    child: Image.asset(
                        "packages/polkawallet_plugin_acala/assets/images/divider.png")),
                LoanInfoPanel(
                  price: price,
